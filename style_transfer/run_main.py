...
import style_transfer.style_transfer as style_transfer
import os
...
def parse_args():
    ...
    parser.add_argument('--content', type=str, default='images/tubingen.jpg',
                        help='File path of content image (notation in the paper : p)', required=True)
    parser.add_argument('--style', type=str, default='images/starry-night.jpg',
                        help='File path of style image (notation in the paper : a)', required=True)
...
def main():
    ...
    content_image = utils.load_image(args.conent, max_size=args.max_size)
    style_image = utils.load_image(args.style, shape=content_image.shape)
